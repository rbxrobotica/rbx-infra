...
pass insert rbx/robson-v2/api-token               # openssl rand -hex 32 (production)
...
|-----------|-------------|------|-------------|
| `robson` | `robsond-secret` | `database-url`, `projection-tenant-id`, `binance-api-key`, `binance-api-secret`, `api-token` | `rbx/robson-v2/*` |
