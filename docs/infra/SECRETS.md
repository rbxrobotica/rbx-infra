...
pass insert rbx/storage/contabo-access-key         # Contabo S3 access key
pass insert rbx/storage/contabo-secret-key         # Contabo S3 secret key
...
| `langfuse` | `langfuse-s3-auth` | `accessKeyId`, `secretAccessKey` | `rbx/storage/contabo-access-key`, `rbx/storage/contabo-secret-key` |
