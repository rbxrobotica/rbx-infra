...
ALLOW_THIRDPARTY='^(postgres|redis|busybox|rabbitmq|python|alpine|nginx|paradedb/paradedb|migrate/migrate|docker\.io/migrate/migrate|ghcr\.io/berriai/litellm|squidfunk/mkdocs|minio/minio|btcpayserver/bitcoin|btcpayserver/btcpayserver|nicolasdorier/nbxplorer|ghcr\.io/plausible/community-edition|clickhouse/clickhouse-server|curlimages/curl)([:@]|$)'
