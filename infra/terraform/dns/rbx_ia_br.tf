...
resource "powerdns_record" "kulinaryos_rbx_ia_br_a" {
  zone    = powerdns_zone.rbx_ia_br.name
  name    = "kulinaryos.rbx.ia.br."
  type    = "A"
  ttl     = 3600
  records = [var.k3s_ingress_ip]
}
...
resource "powerdns_record" "outbox_rbx_ia_br_a" {
  zone    = powerdns_zone.rbx_ia_br.name
  name    = "outbox.rbx.ia.br."
  type    = "A"
  ttl     = 3600
  records = [var.k3s_ingress_ip]
}

resource "powerdns_record" "portal_rbx_ia_br_a" {
  zone    = powerdns_zone.rbx_ia_br.name
  name    = "portal.rbx.ia.br."
  type    = "A"
  ttl     = 3600
  records = [var.k3s_ingress_ip]
}
